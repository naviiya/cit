...
import com.cit.test.helper.SystemUtil;
import com.cit.test.helper.TestCase;
...
public class RuninTestActivity extends Activity {
    ...
    private TestCase.RESULT[] mTestResult;
    TextView[] mTextViews;
    ...
    public RuninTestActivity() {
        mTestResult = new TestCase.RESULT[] { TestCase.RESULT.UNDEF, TestCase.RESULT.UNDEF, TestCase.RESULT.UNDEF,
                TestCase.RESULT.UNDEF, };
    ...
    protected void onCreate(Bundle paramBundle) {
        ...
        memSizeSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case MSG_TEST_FAILED:
                    ...
                    mTestResult[mTestStep] = pass ? TestCase.RESULT.OK : TestCase.RESULT.NG;
...
//        ControlButtonUtil.Hide();
    ...
    protected void endAllTest() {
        boolean pass = true;
        for (TestCase.RESULT result : mTestResult) {
    ...
    protected void stopTest() {
        ...
        mTestResult[mTestStep] = TestCase.RESULT.NG;
        TEST_STEP step = TEST_STEP.values()[mTestStep];
        switch (step) {
            case SLEEP_WAKE_TEST:
                stopSleepWakeTest();
