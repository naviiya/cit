...
public class CameraTest_FrontActivity extends Activity implements Callback {
	private final static String TAG = "CameraTest_FrontActivity";
	private SurfaceView surfaceView;
	private ImageView imageView;
	private TextView resultView;
	private Camera camera;
	private SurfaceHolder mSurfaceHolder;
//	private String picturePath = "/data/data/com.FtTest/picture_front.jpg";
	private String picturePath = "/mnt/sdcard/camera_front.jpg";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.cameratest_front);
...
*/		
		...
		mBtnSnapshotPic.setOnClickListener( new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Log.i( TAG, "[Front] onClick: camera.takePicture(null, null, null, jpegCallbackNotPreview);   ---> camera: " + camera );
				if ( camera != null ) {
					Camera.Parameters parameters = camera.getParameters();
					//parameters.setPictureSize(pictureWidth, pictureHeight);
					parameters.setPreviewSize(640, 480);
		...
		//hehg
		if ( (m_iVideo = checkFrontCamera( FRONT_CAMERA )) < 0 ) {
			flag = false;
			resultView.setText( "ERROR: Not found the Front Camera!!!" );
			Log.i(TAG, "Not found the front camera!");
			...
			Log.i(TAG, "Found the front camera!");
			mSurfaceHolder = surfaceView.getHolder();
			mSurfaceHolder.addCallback(this);
			//mSurfaceHolder.setType( SurfaceHolder.SURFACE_TYPE_PUSH_BUFFERS );
		}
